...
export const loginLimiter = rateLimit({
  ...
  keyGenerator: (req) => {
    // Limit based on the username being attempted, not the IP when available.
    // Fall back to express-rate-limit's ipKeyGenerator to correctly handle IPv6 addresses.
