    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-orange-500/5">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold">Recent Ratings</h1>
                <p className="text-muted-foreground">Browse all professor ratings submitted by the community</p>
              </div>
            </div>
            <Link href="/doctors">
              <Button className="gap-2">
                <Star className="h-4 w-4" /> Rate a Professor
              </Button>
            </Link>
          </div>
        </motion.div>
                    ...
                    <CardContent className="p-4 flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs text-muted-foreground">({doc.ratings?.totalReviews} reviews)</span>
                        </div>
                      </div>
                      <div className="flex items-center gap-1 text-muted-foreground group-hover:text-primary transition-colors">
                        <span className="text-sm hidden sm:block">View</span>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="mt-8 text-center">
          <p className="text-sm text-muted-foreground mb-3">Don't see a professor you want to rate?</p>
          <Link href="/doctors">
            <Button variant="outline" className="gap-2">
              <Clock className="h-4 w-4" /> Browse All Professors
            </Button>
          </Link>
        </motion.div>
      </main>
