...
import { MessageSquareText, MoveLeft, Construction } from "lucide-react";
    ...
    <div className="container px-4 py-10 md:py-20 max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-md mx-auto text-lg pt-2">
          An aggregated view of qualitative feedback and suggestions from your students. This feature is currently under active development.
        </p>
