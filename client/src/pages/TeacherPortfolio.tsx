...
import { FileText, MoveLeft, Construction } from "lucide-react";
...
export default function TeacherPortfolio() {
  ...
  return (
    <div className="container px-4 py-10 md:py-20 max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
      ...
      >
        <div className="h-24 w-24 rounded-full bg-purple-500/10 flex items-center justify-center mb-4">
        ...
        <p className="text-muted-foreground max-w-md mx-auto text-lg pt-2">
          Showcase your syllabus, published materials, and teaching philosophy to prospective students. This feature is currently under active development.
        </p>
